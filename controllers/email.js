...
const email = {
	...
	*/
	registration: function(data){
		...
		let content = "<strong>Hi "+data.user_name+",</strong>";
			...
			content += "<p>If you encountered any issue with the Orbit Tool, please submit a ticket to this link https://orbit-workflow.herokuapp.com/  so we can help you resolve your Orbit-related issue  </p>";
	...
	*/
	admin_registration: function(data){
		...
		let content = "<strong>Hi "+data.user_name+",</strong><br><br>";
			...
			content += "<span>Plase go to https://orbit-workflow.herokuapp.com/ and login as admin and use this following credentials. </span><br><br>";
	...
	*/
	admin_notif: function(data){
		...
		let	content = "<span>New ticket arrived, to view the submitted ticket  <a href='https://orbit-workflow.herokuapp.com/admin/ticket/all'>click here</a> </span><br>";
